...
export const productsJSON: Product[] = [
  {
    id: 1,
    sku: "TRA709T",
    name: "Heavy Duty Staples - Type H 4/11/155",
    description:
      "Used for heavy-duty stapling jobs such as insulation carpet underlayment, these staples come in sturdy plastic packaging.",
    features: [
  ...
  },
  {
    ...
    description:
      "Designed for use with 1/4 in, 5/16 in, 3/8 in, 7/16 in, 1/2 in, and 9/16 in fasteners.",
    features: [
  ...
  },
  {
    ...
    description:
      "Stanley's Heavy-Duty Stainless steel narrow crown staples are ideal for corrosive or marine environments.",
    features: [
      "Color-coded packaging makes size and product selection a cinch",
      "Sturdy plastic packaging reduces staple breakage",
    ],
  ...
  },
  {
    ...
    description:
      "This 1500-pack of 3/8 heavy-duty narrow crown staples are convenient and reliable.",
    features: [
  ...
  },
  {
    ...
    description:
      "For light-duty household and crafting jobs, the Stanley light-duty wide crown staples.",
    features: [
      "Color-coded packaging for easy selection of correct staples",
      "Sturdy plastic packaging helps reduce staple breakage",
    ],
  ...
  },
  {
    ...
    description:
      "Stanley's Heavy-duty narrow crown staples are sure to get the job done right.",
    features: [
      "Color-coded packaging for easy selection of correct staples",
      "Sturdy plastic packaging helps reduce staple breakage",
    ],
  ...
  },
  {
    ...
    description:
      "Introducing the STANLEY® FATMAX® PREMIUM™ 16' Tape: the single answer to all your measuring needs.",
    features: ["16' Max Reach", "FINGER BRAKE FOR ULTIMATE BLADE CONTROL"],
    image:
  ...
  },
  {
    ...
    description:
      "This heavy-duty FATMAX® 15' saw is designed to deliver smooth, sharp cuts.",
    features: [
  ...
  },
  {
    ...
    subCategory: ["Hammers"],
    description:
      "Ideal for striking chisels, punches, start drills and unhardened metals & Anti-Vibe® technology minimizes vibration and shock at impact.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® Control-Grip™ Retractable Utility Knife features an optimized shape for applications that need a precise grip.",
    features: [
  ...
  },
  {
    ...
    subCategory: ["Knives and Blades"],
    description:
      "Have top-quality, high-performance on hand with this 100-pack of Heavy-Duty Utility Blades.",
    features: [
  ...
  },
  {
    ...
    description:
      "Complete a variety of fastening jobs quickly and easily with the Multi-Bit Ratcheting Screwdriver from STANLEY®.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY Bi-material handled adjustable wrench has a tapered jaw design allowing for work in tight spaces, wide capacity jaw, the forged chrome.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® 8 in. Compound Action Long Nose Pliers offer increased cutting force when compared to standard long nose pliers.",
    features: [
  ...
  },
  {
    ...
    description:
      "The Professional Power Station combines a portable household AC power supply with a jump-starter and 120 PSI air-compressor.",
    features: [
  ...
  },
  {
    ...
    description:
      "Designed for superior performance, this nozzle features a durable cast metal body with non-slip grip.",
    features: ["7 spray patterns for a variety of watering needs"],
    category: "Outdoor",
  ...
  },
  {
    ...
    description:
      "Applications are limitless with the STANLEY FATMAX Heavy Duty Adjustable Trigger Nozzle.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® 1600 PSI Pressure Washer is the most portable electric pressure washer we make.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® SLP2050 2-In-1 is the most versatile and innovative electric pressure washer.",
    features: [
  ...
  },
  {
    ...
    description:
      "The Stanley FATMAX Professional Grade Water Hose features advanced technologies to make your work outdoors stress-free.",
    features: ["AntiKink™ Technolgy", "500 PSI"],
    category: "Outdoor",
  ...
  },
  {
    ...
    description:
      "With the STANLEY® ACCUSCAPE® Bulb Planter, planting bulbs in your garden has never been easier.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® 1200 lbs. Poly Cart is just the thing any you need for any heavy-duty outdoor job.",
    features: [
  ...
  },
  {
    ...
    description:
      "Built from heat treated steel and durable fiberglass, the STANLEY® Fiberglass D-Handle Garden Fork is strong enough to stand up to any job.",
    features: [
  ...
  },
  {
    ...
    description:
      "Durable and versatile, the STANLEY® ACCUSCAPE® Fiberglass Round Point Shovel is perfect for any digging or transplanting task.",
    features: [
  ...
  },
  {
    ...
    description:
      "The Stanley Professional Power Station is an all in one solution, a 120 PSI air compressor and portable USB power.",
    features: [
  ...
  },
  {
    ...
    description:
      "The Cordless Handheld Wet/Dry Vacuum is perfect for easy clean-up of wet and dry debris.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY stainless steel 5 gallon wet/dry vacuum features a powerful heavy duty motor for industry leading performance.",
    features: [
  ...
  },
  {
    ...
    description:
      "STANLEY Wet/Dry Vacuums are ideal for wet and dry pick ups in your home, garage, workshop or vehicle.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY SL18127P Portable Poly Series 2 gallon, 2 peak MAX HP wall mounted wet/dry vacuum.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY stainless steel 8 gallon wet/dry vacuum features a powerful motor for industry leading performance.",
    features: ["4 peak MAX HP motor", "8 gallon container", "Airflow: 85 CFM"],
    category: "Power Tools",
    subCategory: ["Vacuum"],
    price: 199.99,
    image:
  ...
  },
  {
    ...
    description:
      "STANLEY SL18123P 3 gallon, 3 peak MAX HP wet/dry vacuum is lightweight.",
    features: [
  ...
  },
  {
    ...
    description:
      "STANLEY 5.5 peak MAX HP 12 gallon wet/dry vacuum, with a powerful motor for industry leading performance.",
    features: [
  ...
  },
  {
    ...
    description:
      "Pros like you know that organization and convenient access to tools can be very advantageous.",
    features: [
  ...
  },
  {
    ...
    description:
      "This STANLEY® 26 in. FATMAX® PRO Toolbox features an integrated IP54 seal.",
    features: [
  ...
  },
  {
    ...
    description:
      "This STANLEY® FATMAX® XL Deep Tool Organizer includes 3 large and 9 medium cups for organization of small tools and parts.",
    features: [
  ...
  },
  {
    ...
    description:
      "Secure your tools and supplies with the Stanley® SortMaster Junior.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® 6-1/2 in. Bin Organizer brings organization to any workspace.",
    features: [
  ...
  },
  {
    ...
    description:
      "STANLEY® FATMAX® Technician Tool Bag. Multiple easy access pockets & compartments, tape chain & tape holder.",
    features: [
  ...
  },
  {
    ...
    description:
      "STANLEY® FATMAX® 14 in Open Mouth Tool Bag is convenient and reliable.",
    features: [
  ...
  },
  {
    ...
    description:
      "This 26-inch wide 4-Drawer Rolling Tool Cabinet is constructed of all-steel for strength and durability.",
    features: [
  ...
  },
  {
    ...
    description:
      "With a large capacity, and robust 7' wheels, the Essential™ Mobile Chest is a jobsite go-to.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY FATMAX® Rolling Tool Case  features a unique accordion structure, with various inner organization storage.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® Folding Adjustable Height and Width Sawhorse (Pair) provides a quick and convenient makeshift workbench.",
    features: [
  ...
  },
  {
    ...
    description:
      "Made for trade workers who require a versatile, portable working surface.",
    features: [
  ...
  },
  {
    ...
    description:
      "Help your future construction expert develop their hand-eye coordination, fine motor skills, and problem-solving skills with the Take Apart Cement Truck Toy Kit.",
    features: [
  ...
  },
  {
    ...
    description:
      "Ideal for children who like to take apart and put back together toys, this 25-piece Take Apart Front Loader Toy Kit",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® Waterproof LED Headlamp has up to 22 hours of runtime making it ideal for indoor and outdoor projects.",
    features: [
  ...
  },
  {
    ...
    description:
      "Reduce bacteria on the skin with the STANLEY® Earth Hand Sanitizer Gel.",
    features: [
  ...
  },
  {
    ...
    description:
      "The STANLEY® SurgeMax pro features 400-J surge protection ion. Its spaced outlet design provides ample room for adapters and other large plugs.",
    features: [
  ...
  },
  {
    ...
    description:
      "These 1.5 in. by 16 ft. heavy-duty and weather-resistant premium 2 pc.",
    features: [
  ...
  },
  {
    ...
    name: "SurgeQuad USB",
    description:
      "Introducing the STANLEY SurgeQuad and USB Wall Tap, the ultimate solution to your power needs.",
    features: [
  ...
  },
  {
    ...
    description:
      "This powerful Heavy-Duty Vacuum Mount Suction Cup attaches to any smooth, flat surface, and can be used for many purposes.",
    features: [
